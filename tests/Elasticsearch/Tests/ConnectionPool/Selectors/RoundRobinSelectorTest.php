...
class RoundRobinSelectorTest extends \PHPUnit_Framework_TestCase
{
     ...
     *
     * @covers \TippingCanoeEs\ConnectionPool\Selectors\RoundRobinSelector::select
     *
     * @return void
     */
    public function testTenConnections()
    {
        ...
        foreach (range(0,10) as $index) {
            $mockConnections[$index] = $this->getMockBuilder('\TippingCanoeEs\Connections\CurlMultiConnection')
