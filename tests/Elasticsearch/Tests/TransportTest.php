...
class TransportTest extends \PHPUnit_Framework_TestCase
{
     ...
     *
     * @covers \TippingCanoeEs\Transport::__construct
     * @return void
     */
    ...
    public function testSniffOnStart()
    {
        ...
        $mockConnectionPool = m::mock('\TippingCanoeEs\ConnectionPool\StaticConnectionPool')
        ...
        $mockSerializer = m::mock('\TippingCanoeEs\Serializers\SerializerInterface');

        $mockConnection = m::mock('\TippingCanoeEs\Connections\ConnectionInterface');
    ...
    /**
     * @expectedException \TippingCanoeEs\Common\Exceptions\NoNodesAvailableException
     */
